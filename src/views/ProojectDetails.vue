              ...
              <v-card>
                ...
                <v-card-text>
                  ...
                  <p>
                    ...
                    neverending release, there’s <strong>no deadline</strong>,
                    you can suggest your track whenever you want (as long as
                    there is someone to manage the label).
                  </p>
                </v-card-text>
                ...
                <v-card-text>
                  <p>
                    Once your track polished in our studio, it will appear on
                    this page and Bandcamp, ready to be listened by everyone in
                    the world&nbsp;!
                  </p>
                  <p>
                    Once there will be enough tracks for a marvelous
                    compilation, the release will appear on the “Releases” part
                    of Proot rec. website.
                  </p>
